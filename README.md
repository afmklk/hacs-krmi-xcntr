...
6. Log in.
7. In Network search/filter for the `loginCallback` request. Copy the full request URL (it should look something https://portal.kermi.com/xcenterui/xcenter/auth/loginCallback?code=...).
